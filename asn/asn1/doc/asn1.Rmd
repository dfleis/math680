...
\begin{align*}
  ...
  &= \frac{n}{2\sigma^2} - \frac{1}{2\sigma^4} \lVert \tilde Y - \tilde X \hat\beta \rVert^2_2 \\
...
\frac{n}{2\sigma^2} - \frac{1}{\sigma^4} \lVert \tilde Y - \tilde X \beta \rVert^2_2 &= 0,
\end{align*}
...
\begin{equation*}
  \hat\sigma^{2\,\left(\lambda,\, ML\right)} = \frac{2}{n} \lVert \tilde Y - \tilde X \hat\beta^{\left(\lambda,\, ML\right)} \rVert^2_2
\end{equation*}
...
(5) Update our coefficient estimate $\hat\beta^{\left(\lambda,\, ML\right)}$ using the new estimate of $\hat\sigma^{2\,\left(\lambda,\, ML\right)}_i$.
